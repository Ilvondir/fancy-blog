    ...
    <div class="section no-pad-bot">
        <div class="container">
          ...
          <div class="row center">
            <h5 class="header col s12 white-text light">We are a team of passionate individuals with a deep love for all things of IT and life. Join us as we explore the exciting realm of technology together!</h5>
          </div>
          <br><br>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Discover how technology fuels success and positivity in everyday life. Join us for uplifting stories and practical insights. Let's embrace the potential of tech together!</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Boost your efficiency with cutting-edge tech tips. Unleash your potential and embrace a tech-savvy lifestyle. Transform the way you work and live.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Explore inspiring journeys of tech enthusiasts. Dive into motivating stories from the world of IT. Be inspired by the limitless possibilities of technology.</p>
          </div>
        </div>
      </div>
...
<div class="parallax-container valign-wrapper" style="height: 200px; justify-content: center;">
    ...
    <div class="parallax"><img src="{{ asset("img/desk.jpg") }}" alt="Desk."></div>
        ...
        {{-- <div class="row" style="box-sizing: border-box; margin: 0">
            <div class="col s12 l6 blue white-text" style="padding: 15px">
                <h5>
                    Our goals
                </h5>
                <p class="light">
                    At our blog, we specialize in delivering inspiring and accessible programming and technology education. Our content is crafted for everyone, from beginners to advanced learners. Explore the world of coding and enhance your technical skills with us!
                </p>
                <p class="light">
            ...
            <div class="col s12 l6" style="padding: 0">
                <h5 class="center">Last article</h5>
