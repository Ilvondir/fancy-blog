<nav class="nav-extended blue" style="box-shadow: none">
    ...
    <div class="nav-content">
      <ul class="tabs tabs-transparent">
        ...
        <li class="tab @if ( str_contains(request()->path(), "tags") ) active @endif"><a href="{{ route("index.tags") }}" class="@if ( str_contains(request()->path(), "tags") ) active @endif"><i class="fa-solid fa-hashtag" style="font-size: 120%; margin-right: 3px"></i> Tags</a></li>
